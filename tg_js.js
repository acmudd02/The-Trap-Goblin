//Create arrays for each of the selections
 ...
 ['10d6', '18d6', '24d6']
  ...
  [ '  Suddenly, arcing currents of electricity dance on hidden panels in the floor, dealing ', '  Suddenly, a bolt of lightning erupts from a pair of diamonds set in the wall, dealing ', '  Suddenly, a bolt of lightning roars from a fresco of a storm cloud on the cieling, dealing ', '  Suddenly, a jar filled with a blue potion drops from a hidden chute, dealing ', '  Suddenly, the hum of electricity can be heard coming from the walls, the floor sparks, dealing ', '  Suddenly, there is a flash of light, as a bolt of electricity strikes, dealing ' ],
  [ '  Suddenly, an arctic wind blows from a hidden passage, dealing ', '  Suddenly, a cold mist forms around, dealing ', '  Suddenly, an orb of glacial ice drops from the cieling, dealing ', '  Suddenly, a puff of arctic wind blows from hidden tubes, dealing ', 'Suddenly, the floor drops, giving way to a pool of unbelievably cold water, dealing ', 'Suddenly, a blue bolt of arcane enrgy leaps from a rod in the center of the room, dealing '],
  [ '  Suddenly, a spectral hand reachs through the wall, dealing ', '  Suddenly a ray of green energy blasts from a hiddne panel, dealing ', '  Suddenly, a statue of a mummy touches, dealing ', '  Suddenly, a screaming skull descends from the cieling and strikes, dealing ', '  Suddenly, the floor takes on a greenish incadescence, dealing ', '  Suddenly, there is a flash of green light, and a skeletal figure lashes out, dealing ']];

var dmg = $("#type option:selected").text();

var rando_dmg_selector = [ ' piercing ', ' slashing ', ' crushing ', ' fire ', ' electric', ' cold ', ' necrotic ']
  ...
  function get_level(){
    ...
    document.getElementById("trap").innerHTML = 'Your Trap:  ' + damage[dmg_type][random] + levels[lvl][sev] + ' ' + dmg + " damage." + " To Hit: " + to_hit[sev]  + " To Save: " + save[sev];
}
  ...
  function random_trap() {
    ...
    var dmg =
    document.getElementById("trap").innerHTML = 'Your Trap:  ' + damage[random_dmg_type][random_txt] + levels[random_lvl][random_sev] + ' ' + rando_dmg_selector[random_dmg_type] + " damage." + " To Hit: " + to_hit[random_sev]  + " To Save: " + save[random_sev];
  }
